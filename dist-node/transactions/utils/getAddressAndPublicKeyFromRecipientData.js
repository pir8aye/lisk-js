...
var getAddressAndPublicKeyFromRecipientData = function getAddressAndPublicKeyFromRecipientData(_ref) {
	...
	if (recipientId && recipientPublicKey) {
		var addressFromPublicKey = _crypto2.default.getAddressFromPublicKey(recipientPublicKey);
	...
	if (!recipientId && recipientPublicKey) {
		var _addressFromPublicKey = _crypto2.default.getAddressFromPublicKey(recipientPublicKey);
