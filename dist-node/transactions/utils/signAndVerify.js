 ...
 *
 */
var signTransaction = exports.signTransaction = function signTransaction(transaction, secret) {
  var transactionHash = (0, _getTransactionHash2.default)(transaction);
  return _crypto2.default.signData(transactionHash, secret);
};
...
var multiSignTransaction = exports.multiSignTransaction = function multiSignTransaction(transaction, secret) {
